...
global {
	...
	string epidemiological_reinfection_interval <- "Reinfection_interval";
	
	//string epidemiological_effectiveness_vaccine_1stdose <- "Effectiveness_vaccine_1stdose";
	//string epidemiological_effectiveness_vaccine_2nddose <- "Effectiveness_vaccine_2nddose";
